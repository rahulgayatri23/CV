...
%Down below is the tabular form in case you want to save space
%%
%    \begin{center}
...
%%
%            \begin{center} Programming Models \end{center} & \begin{center} OpenMP{3.0, 4.5}, Cuda, Kokkos, OpenACC, OMPSs, Pthreads, STM, MPI \end{center} \\ \hline
%%
